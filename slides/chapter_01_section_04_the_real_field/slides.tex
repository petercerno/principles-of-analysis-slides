...
\begin{frame}{Theorem 1.19: Visualizing $\mathbb{R}$ and $\mathbb{Q}$}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{$\mathbb{R}$ \alert{fills all the gaps} in $\mathbb{Q}$ --- it is a \emph{complete} ordered field.}
  \end{center}
...
\begin{frame}[c]{Density of $\mathbb{Q}$ in $\mathbb{R}$: Illustration}
  \begin{center}
...
\begin{frame}[c]{Proof of 1.20(b): Visual Summary}
  \begin{center}
  \begin{tikzpicture}[scale=1.0]
    % Number line
...
\begin{frame}{Theorem 1.21: Existence of $n$th Roots}
  ...
  \vspace{0.5em}
  \begin{center}
    \hl{This number $y$ is written $\sqrt[n]{x}$ or $x^{1/n}$.}
  \end{center}
...
\begin{frame}{Summary}
  ...
  \vspace{0.8em}
  \hl{\textbf{Coming up next:} The extended real number system ($+\infty$ and $-\infty$).}
