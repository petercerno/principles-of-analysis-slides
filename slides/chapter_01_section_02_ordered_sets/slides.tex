...
\begin{frame}{Definition 1.7: Upper and Lower Bounds}
  ...
  \vspace{0.3em}
  \hl{\alert{Lower bounds} are defined symmetrically (with $\geq$ in place of $\leq$).}
...
\begin{frame}{Definition 1.8: Least Upper Bound (Supremum)}
  ...
  \begin{tikzpicture}[scale=1.1]
    ...
    \draw[very thick, blue] (1,0) -- (3.5,0);
    \fill[blue] (1,0) circle (2pt) node[below=4pt]{\footnotesize$a$};
    \draw[blue, fill=white] (3.5,0) circle (2pt) node[below=4pt]{\footnotesize$b$};
    \node[blue, above=4pt] at (2.25,0) {$E$};
    % Upper bounds region
    \draw[thick, red, ->] (3.5,0.35) -- (6.3,0.35);
...
\begin{frame}{Definition 1.8: Greatest Lower Bound (Infimum)}
  ...
  \begin{tikzpicture}[scale=1.1]
    ...
    \draw[blue, fill=white] (2,0) circle (2pt) node[below=4pt]{\footnotesize$a$};
...
\begin{frame}{Example 1.9(a): No Supremum in $\mathbb{Q}$}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[blue, fill=white] (3.2,0) circle (2pt);
    \node[blue, above=4pt] at (1.8,0) {$A$};
    % Set B
    \draw[very thick, red] (3.2,0) -- (6.5,0);
    \draw[red, fill=white] (3.2,0) circle (2pt);
...
\begin{frame}{Example 1.9(b): Supremum May or May Not Belong to $E$}
  ...
  \vspace{0.3em}
  \hl{Let $E_1 = \{r \in \mathbb{Q} : r < 0\}$ and $E_2 = \{r \in \mathbb{Q} : r \leq 0\}$.}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[blue, fill=white] (2.5,0.8) circle (2pt) node[above=4pt]{\footnotesize$0$};
...
\begin{frame}{Example 1.9(b): Supremum May or May Not Belong to $E$}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \draw[blue, fill=white] (2.5,1.2) circle (2pt) node[above=4pt]{\footnotesize$0$};
  ...
  \vspace{0.3em}
  \hl{Both have $\sup = 0$, but membership differs.}
...
\begin{frame}{Example 1.9(c): The Set $\{1/n\}$}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    % Zero
    \draw[teal, fill=white] (0.2,0) circle (2.5pt) node[below=6pt]{\footnotesize$0$};
    % Annotations
...
\begin{frame}{Definition 1.10: Least-Upper-Bound Property}
  ...
  \vspace{0.5em}
  \hl{Example 1.9(a) shows: \alert{$\mathbb{Q}$ does \emph{not} have the least-upper-bound property.}}
...
\begin{frame}{Summary}
  ...
  \vspace{1em}
  \hl{\textbf{Coming up next:} Fields --- the algebraic structure of $\mathbb{Q}$ and $\mathbb{R}$.}
