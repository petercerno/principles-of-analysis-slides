...
\begin{frame}{Axiom (A1): $\alpha + \beta$ Is a Cut}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{$\boxed{\alpha + \beta \text{ is a cut}}$}
  \end{center}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_01_bg_07.png}%
}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_01_bg_08.png}%
}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_01_bg_09.png}%
}
...
\begin{frame}{Summary}
  ...
  \vspace{0.5em}
  \hl{\textbf{Coming up next:} Chapter 2 --- Basic Topology.}
