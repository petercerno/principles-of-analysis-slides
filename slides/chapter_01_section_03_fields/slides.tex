...
\begin{frame}{Definition 1.12: The Distributive Law}
  ...
  \vspace{0.5em}
  \hl{The distributive law is the \alert{bridge} between addition and multiplication.}
...
\begin{frame}{Remarks 1.13: $\mathbb{Q}$ Is a Field}
  ...
  \vspace{0.5em}
  \hl{All ten axioms (A1)--(A5), (M1)--(M5), and (D) hold in $\mathbb{Q}$.}
...
\begin{frame}{Proof of Proposition 1.16(a): $0x = 0$}
  \hl{\small\textbf{Recall 1.14(b):} $x + y = x \;\Rightarrow\; y = 0$}
...
\begin{frame}{Proof of Proposition 1.16(c): $(-x)y = -(xy)$}
  \hl{\small\textbf{Recall 1.14(c):} $x + y = 0 \;\Rightarrow\; y = -x$}
...
\begin{frame}{Proof of Proposition 1.16(d): $(-x)(-y) = xy$}
  \hl{\small\textbf{Recall 1.16(c):} $(-x)y = -(xy)$}\quad\hl{\small\textbf{Recall 1.14(d):} $-(-x) = x$}
...
\begin{frame}{Proof of Proposition 1.18(c)}
  \hl{\small\textbf{Recall 1.16(c):} $(-x)y = -(xy)$}
...
\begin{frame}{Proof of Proposition 1.18(d)}
  \hl{\small\textbf{Recall 1.16(d):} $(-x)(-y) = xy$}\quad\hl{\small\textbf{1.17(ii):} $x,y > 0 \Rightarrow xy > 0$}
...
\begin{frame}{Summary}
  ...
  \vspace{1em}
  \begin{hlbox}
  \textbf{Coming up next:} The Real Field --- constructing $\mathbb{R}$.
  \end{hlbox}
