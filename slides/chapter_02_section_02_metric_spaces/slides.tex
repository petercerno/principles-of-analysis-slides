...
\begin{frame}{Definition 2.17: Segments and Intervals}
  ...
  Also: half-open intervals $[a, b)$ and $(a, b]$.
...
\begin{frame}{Definition 2.17: Segments and Intervals}
  ...
  \vspace{0.3em}
  A 1-cell is an interval. A 2-cell is a rectangle.
...
\begin{frame}{Definition 2.17: Open and Closed Balls}
  ...
  \begin{tikzpicture}[scale=0.9]
    ...
    \node[blue] at (0, -2.1) {Open ball: boundary \emph{not} included};
    ...
    \begin{scope}[xshift=9cm]
      ...
      \draw[thick, red, <->] (0,0) -- (1.5,0) node[midway, above]{$r$};
      \node[red!80!black] at (0, -2.1) {Closed ball: boundary included};
    \end{scope}
  \end{tikzpicture}
  \end{center}
...
\begin{frame}{Definition 2.17: Convex Sets}
  ...
  \vspace{0.3em}
  \textbf{Fact:} Balls are convex. $k$-cells are convex.
...
\begin{frame}{Definition 2.18: Topological Vocabulary}
  ...
  \vspace{0.3em}
  \textbf{Note:} In $R^1$ neighborhoods are segments; in $R^2$ neighborhoods are open disks.
...
\begin{frame}{Proof of Theorem 2.20}
  ...
  \vspace{0.5em}
  \textbf{Corollary:}\; A finite point set has no limit points.
...
\begin{frame}{Examples 2.21: Subsets of $R^2$}
  ...
  \vspace{0.3em}
  \textbf{Note on (e):} $E$ has a limit point ($z = 0$) that is \emph{not in} $E$.
...
\begin{frame}{Theorem 2.23: Open Sets and Closed Complements}
  ...
  \vspace{0.5em}
  \textbf{Corollary:}\; A set $F$ is closed if and only if $F^c$ is open.
...
\begin{frame}{Theorem 2.27: Properties of Closure}
  ...
  \vspace{0.3em}
  By (a) and (c): $\bar{E}$ is the \alert{smallest} closed set containing $E$.
...
\begin{frame}{Remark 2.29: Open Relative to a Subspace}
  ...
  \vspace{0.3em}
  \textbf{Recall:} $(a, b)$ is open in $R^1$ but not open in $R^2$.
...
\begin{frame}{Summary}
  ...
  \begin{itemize}
    ...
    \item The \alert{closure} $\bar{E} = E \cup E'$ is the smallest closed set containing $E$
      (Thm.\ 2.27). Relatively open sets are characterized by $E = Y \cap G$
      (Thm.\ 2.30).
  \end{itemize}
...
\begin{frame}{Coming Up Next}
  \textbf{Coming up next:} Compact sets --- a powerful finiteness condition.
