...
\begin{frame}{Theorem 1.31: Properties of Conjugation}
  ...
  \vspace{0.3em}
  \hl{\textbf{Key fact:} $z\bar{z} = a^2 + b^2$}
...
\begin{frame}{Proof of Theorem 1.33(e): Triangle Inequality --- Conclusion}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{Taking square roots: $\boxed{|z + w| \leq |z| + |w|}$}
  \end{center}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_01_bg_06.png}%
}
% =============================================================================
% SUMMARY
% =============================================================================
...
\begin{frame}{Summary}
  \begin{hlbox}
    ...
    \begin{itemize}
      \item Complex numbers are ordered pairs of reals, forming a \alert{field} $\mathbb{C}$
    \end{itemize}
  \end{hlbox}
...
\begin{frame}{Summary}
  ...
  \vspace{1em}
  \hl{\textbf{Coming up next:} Euclidean Spaces --- generalizing $\mathbb{C}$ to $\mathbb{R}^k$.}
