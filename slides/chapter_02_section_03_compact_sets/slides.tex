...
\begin{frame}{Visualizing an Open Cover}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \node at (0,-2.4) {\hl{$\displaystyle E \subset G_1 \cup G_2 \cup G_3 \cup G_4$}};
  \end{tikzpicture}
  \end{center}
...
\begin{frame}{Visualizing the Separation}
  ...
  \begin{tikzpicture}[scale=1.0]
    ...
    \node at (0,-2.5) {\hl{$V = V_{q_1} \cap V_{q_2} \cap V_{q_3}$ is disjoint from $W = W_{q_1} \cup W_{q_2} \cup W_{q_3}$}};
  \end{tikzpicture}
  \end{center}
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_02_bg_07.png}%
}
% =============================================================================
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_02_bg_08.png}%
}
% =============================================================================
...
\begin{frame}{Theorem 2.41: Heine-Borel}
  ...
  \vspace{0.3em}
  \begin{hlbox}
    \textbf{Note:} The equivalence of (a) and (b) is the Heine-Borel theorem.
  \end{hlbox}
...
\begin{frame}{Visualizing the Closure Argument}
  ...
  \begin{center}
    \hl{\small All but finitely many $\mathbf{x}_n$ lie inside the ball --- so $\mathbf{y}$ is not a limit point of $S$.}
  \end{center}
  \vfill
...
{
\usebackgroundtemplate{%
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio=false]{chapter_02_bg_09.png}%
}
% =============================================================================
\section{Summary}
% =============================================================================
