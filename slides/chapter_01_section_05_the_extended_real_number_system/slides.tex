...
\begin{frame}{Definition 1.23: The Extended Real Number System}
  ...
  \vspace{0.5em}
  \hl{The original order among real numbers is preserved.}
...
\begin{frame}{Summary}
  ...
  \vspace{1em}
  \begin{hlbox}
    \textbf{Coming up next:} The Complex Field --- extending $\mathbb{R}$ in a completely different direction.
  \end{hlbox}
