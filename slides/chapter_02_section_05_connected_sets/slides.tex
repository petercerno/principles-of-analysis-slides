...
\begin{frame}{Picture: The ``No Holes'' Property}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{A gap between two points of $E$ immediately breaks connectedness.}
  \end{center}
...
\begin{frame}{Part (A): Property Fails $\;\Longrightarrow\;$ Not Connected}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{Goal: exhibit $E = A_z \cup B_z$ with $A_z, B_z$ \alert{nonempty and separated}.}
  \end{center}
...
\begin{frame}{Part (B): Not Connected $\;\Longrightarrow\;$ Property Fails}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{Plan: find $z^\ast$ with $x < z^\ast < y$ and $z^\ast \notin E$.}
  \end{center}
...
\begin{frame}{Part (B): The Key Construction --- $z = \sup(A \cap [x,y])$}
  ...
  \begin{thmblock}{Recall: Theorem 2.28}
...
\begin{frame}{Part (B): Case 1 --- $z \notin A$}
  ...
  \vspace{0.5em}
  \begin{center}
    \hl{The property $x, y \in E, \; x < z < y \Rightarrow z \in E$ \alert{fails at this $z$}.}
  \end{center}
...
\begin{frame}{Part (B): Case 2 --- $z \in A$}
  ...
  \vspace{0.3em}
  \begin{center}
    \hl{In both cases the in-between property fails \quad $\blacksquare$}
  \end{center}
...
\begin{frame}{Summary}
  \begin{hlbox}
    ...
    \end{itemize}
    \begin{center}
      \textbf{Coming up next:} \emph{Numerical Sequences and Series} --- convergence, Cauchy sequences, and the central limit notion of analysis.
    \end{center}
  \end{hlbox}
