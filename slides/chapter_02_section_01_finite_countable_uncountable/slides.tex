...
\begin{frame}{Definition 2.1: Visualizing a Function}
  ...
  \vspace{0.3em}
  Range $= f(A) = \{b_1, b_2, b_3\} = B$, so this $f$ maps $A$ \alert{onto} $B$.
...
\begin{frame}{Remarks 2.11: Algebraic Properties of Set Operations}
  ...
  \begin{align*}
    ...
    &\text{If } A \subset B: \quad A \cup B = B, \quad A \cap B = A
  \end{align*}
...
\begin{frame}{Theorem 2.12: Countable Union of Countable Sets}
  ...
  \vspace{0.5em}
  \textbf{In words:} A countable union of countable sets is countable.
...
\begin{frame}{Corollary of Theorem 2.12}
  ...
  \vspace{0.5em}
  \emph{Proof:} $T$ is equivalent to a subset of the array from Theorem 2.12.
...
\begin{frame}{Summary}
  ...
  \vspace{0.5em}
  \textbf{Coming up next:} Metric Spaces --- adding the concept of \emph{distance} to sets.
